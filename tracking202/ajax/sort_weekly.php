...
//grab breakdown report	
	...
	<table cellpadding="0" cellspacing="1" class="m-stats">
		<tr>   
			...
			<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_weekly.php','','<? echo $html['sort_breakdown_click_throughs_order']; ?>');">Click Outs</a></th>
			<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_weekly.php','','<? echo $html['sort_breakdown_ctr_order']; ?>');">CTR</a></th>
